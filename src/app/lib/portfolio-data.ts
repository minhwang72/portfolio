...
- 학력: 방송통신대학교 (컴퓨터과학과)
- GitHub: https://github.com/minhwang72
...
2. HEXAVEIL - 주임연구원 (2023.03.27 ~ 2025.05.16, 약 2년 2개월)
   - Flutter 기반 모바일 앱부터 React 기반 웹 프론트엔드, Django/Spring Boot 백엔드, CI/CD 자동화, 클라우드 인프라 운영까지 전방위 담당
   - 주요 업무: Flutter/Android/iOS 앱 설계/구현, Next.js 웹 프론트엔드 개발, Firebase/Django/Spring Boot 백엔드 구축, Docker/GitHub Actions/TeamCity 배포 자동화, AWS 인프라/DB 운영 (MariaDB), 디자인 협업 및 UI/UX 개선 (Figma, Zeplin)
